...
class Userinterface():
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score = Label(text="Score:0", fg="white", bg=THEME_COLOR, font=("Arial", 20, "bold"))
        self.score.grid(row=0, column=1)

        self.canvas = Canvas(width=500, height=400)
        self.question = self.canvas.create_text(250, 200,
                                                text="Text",
                                                width=300,
                                                fill=THEME_COLOR,
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.flase_button.config(state='disabled')
    ...
    def give_feedback(self, is_tight):
        if is_tight:
